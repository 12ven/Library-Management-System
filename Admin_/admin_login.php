...
<section>
  <div class="log_img">
   <br>
    <div class="box1">
        <h1 style="text-align: center; font-size: 25px; color: black;">Admin Login Form</h1><br>
      ...
      <p style="color: white; padding-left: 15px;">
        ...
        <span style="color: black;">New to this website?</span><a style="color: blue; text-decoration: none;" href="registration.php">&nbspSign Up</a>
      </p>
    </form>
    </div>
  </div>
