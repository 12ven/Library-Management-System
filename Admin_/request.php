...
<div class="container">
	...
	<h3 style="text-align: center;">Requested Books</h3>

	<?php
	
	if(isset($_SESSION['login_user']))
	{
		$sql= "SELECT student.email,roll,books.bid,name,authors,edition,status FROM student inner join issue_book ON student.email=issue_book.email inner join books ON issue_book.bid=books.bid WHERE issue_book.approve =''";
