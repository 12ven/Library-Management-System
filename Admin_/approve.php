...
<?php
  ...
  {
    mysqli_query($db,"UPDATE  `issue_book` SET  `approve` =  '$_POST[approve]', `issue_date` =  '$_POST[issue]', `return_date` =  '$_POST[return]' WHERE email='$_SESSION[login_user]' and bid='$_SESSION[bid]';");

    mysqli_query($db,"UPDATE books SET quality = quality-1 where bid='$_SESSION[bid]' ;");

    $res=mysqli_query($db,"SELECT quality from books where bid='$_SESSION[bid];");
